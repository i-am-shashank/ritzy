    ...
    <>
      ...
      >
        <Box mb="12.5rem" textAlign="center">
          <Image
            src={Logo}
            h={{ sm: "1.2rem", md: "1.5rem", lg: "1.8rem", xl: "2.5rem" }}
            w={{ sm: "1.2rem", md: "1.5rem", lg: "1.8rem", xl: "2.5rem" }}
          />
          <Text
            color="white"
            fontSize={{
        ...
        <Box mb="10.5rem" textAlign="center" color="white">
          <Text
            fontSize={{ sm: "1.2rem", md: "1.4rem", lg: "1.6rem", xl: "2rem" }}
            letterSpacing={{
              sm: "0.2rem",
              md: "0.5rem",
              lg: "0.7rem",
          ...
          <Text
            fontSize={{ sm: "0.6rem", md: "0.7rem", lg: "0.8rem", xl: "1rem" }}
            letterSpacing={{ sm: "0.1rem", md: "0.3rem", lg: "0.4rem" }}
          >
      ...
      <Text
        align="center"
        fonts="sec"
        fontSize={{ sm: "0.8rem", md: "1rem", lg: "1.6rem" }}
        mt="1.5rem"
      >
      ...
      <Center
        display={{ sm: "none", md: "none", lg: "block", xl: "none" }}
        mt="3rem"
      >
